//* Load this lib once in memory  عشان الكومبيلر ميستدعيهاش كذا مرة ويبقا فيه نسخ كتيرة فا هيعمل ايرور
#pragma once
...
public:
	...
	void ReplaceWordInString(string S1, string sRepalceTo)
	{
		_Value = ReplaceWordInString(_Value, S1, sRepalceTo);
	}
};
