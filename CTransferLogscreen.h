...
class CTransferLogScreen : protected CScreen
{
	static void PrintTransferLogRecordLine(CBankClient::stTrnsferLogRecord TransferLogRecord)
	{
...
public:
	...
	static void ShowTransferLogScreen()
	{
		...
		vector <CBankClient::stTrnsferLogRecord> vTransferLogRecord = CBankClient::GetTransfersLogList();
		...
		if (vTransferLogRecord.size() == 0)
			...
			for (CBankClient::stTrnsferLogRecord Record : vTransferLogRecord)
			{
